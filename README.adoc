...
image:https://github.com/codeready-toolchain/member-operator/actions/workflows/workflow.yml/badge.svg[Operator CD,link="https://github.com/codeready-toolchain/member-operator/actions/workflows/workflow.yml"]
...
Following Makefile target takes care of additional several steps which can be executed separately:
