...
replace (
	...
	github.com/codeready-toolchain/toolchain-common v0.0.0-20240207000544-9cd055b3a18c => github.com/ranakan19/toolchain-common v0.0.0-20240229203223-5f7e00e9d818
)
