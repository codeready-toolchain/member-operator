...
require (
	...
	github.com/codeready-toolchain/host-operator v0.0.0-20220407205448-b75e881d6182
...
replace github.com/codeready-toolchain/api => github.com/ranakan19/api v0.0.0-20220412032539-b37959584654
